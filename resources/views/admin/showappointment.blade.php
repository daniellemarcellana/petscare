        ...
        <div class="container-fluid page-body-wrapper">
            <div class="float-right">
                ...
                <form action="{{ url('search') }}" method="get">
                    ...
                    <input type="text" class="float-left text-dark py-2 rounded my-3 mx-2"
                        placeholder=" Search by Name " name="searchTerm" />
                    <a class="btn btn-success float-left py-2 my-3"><input type="submit" class="btn"
                            value="Search"></a>
                </form>
                ...
                <table>
                    ...
                    @foreach ($data as $appoint)
                        <tr align="center" style="background-color: white; color: black;">
                            ...
                            <td><a class="btn btn-primary" href="{{ url('emailview', $appoint->id) }}">Send Mail</a>
                            </td>
