                            ...
                            <div class="card" style="background-color: white; color: black;">
                                <div class="card-body">
                                    <h3 class="card-title font-weight-bold"
                                        style="font-size:
                                        28px; color: black; text-align: left;">
                                        <i class="fas fa-plus"></i>Send an Email</h3>
                                    <p style="text-align: left;">Please fill out this form for sending an email.</p>
                                    <hr>
                                    ...
                                    <form action="{{ url('sendemail', $data->id) }}" method="POST">
                                        ...
                                        <div style="padding: 15px;">
                                            ...
                                            <input type="text" name="greeting" placeholder="Write the name"
                                                style="color:black">
